...
describe('writeFirstRunConfig', () => {
  ...
  it('writes a v3 .anatoly.yml with version: 3 marker', () => {
  ...
  it('lite tier does not write embeddings-ready.json', () => {
    writeFirstRunConfig(dir, { tier: 'lite' });
  ...
  it('external tier still writes embeddings-ready.json (legacy compat)', () => {
    writeFirstRunConfig(dir, { tier: 'external' });
    const flagPath = join(dir, '.anatoly', 'embeddings-ready.json');
