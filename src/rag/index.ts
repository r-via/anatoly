...
export { detectHardware, resolveEmbeddingModels, readEmbeddingsReadyFlag, determineBackend, CODE_MODEL_ID, NLP_MODEL_ID, SIDECAR_MODEL, SIDECAR_NLP_MODEL, MODEL_REGISTRY, GGUF_DOCKER_IMAGE, GGUF_CODE_PORT, GGUF_NLP_PORT, GGUF_CODE_MODEL_FILE, GGUF_NLP_MODEL_FILE, GGUF_MIN_VRAM_GB } from './hardware-detect.js';
